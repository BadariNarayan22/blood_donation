...
<style>
  ...
  <section class="text-center mt-5 mb-5"> <img src="Screenshot 2023-12-24 231120.png" width="50%"  alt="100%"></section>


  
  <form  id="rform" action="regReceiver" method="post">
    <h2><b>Receiver Information Form</b></h2>
    <label for="receiverName">Name:</label>
    <input type="text" id="receiverName" name="receiverName" placeholder="Enter your name" required>
    
    <label for="bloodGroup">Blood Group:</label>
    <input type="text" id="bloodGroup" name="receiverBloodGroup" placeholder="Enter your blood group" required>
    
    
    <label for="receiverAge">Age:</label>
    <input type="text" id="receiverAge" name="receiverAge" placeholder="Enter your age " required>

    <label for="receiverPhone">Phone Number:</label>
    <input type="text" id="receiverPhone" name="receiverPhone" placeholder="Enter your phone number" required>
    
    <label for="receiverEmail">Email:</label>
    <input type="email" id="receiverEmail" name="receiverEmail" placeholder="Enter your email" required>

     <label for="receiverAddress">City:</label><select id="receiverAddress" name="receiverAddress"> 
